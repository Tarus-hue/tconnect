                    ...
                    <?php echo e(csrf_field()); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group full-input">
                                <input type="number" class="form-control" name="amount" placeholder="<?php echo app('translator')->getFromJson('user.enter_amount'); ?>" >
                            </div>
...
<?php echo $__env->make('provider.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\t_connect\resources\views/provider/wallet/wallet_transation.blade.php ENDPATH**/ ?>