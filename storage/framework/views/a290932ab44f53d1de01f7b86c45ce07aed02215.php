          ...
          <div class="modal-body">
            <div class="row no-margin" id="card-payment">
                <div class="form-group col-md-12 col-sm-12">
                    ...
                    <input data-stripe="name" autocomplete="off" required type="text" class="form-control" placeholder="<?php echo app('translator')->getFromJson('user.card.fullname'); ?>">
                </div>
                <div class="form-group col-md-12 col-sm-12">
                    <label><?php echo app('translator')->getFromJson('user.card.card_no'); ?></label>
                    <input data-stripe="number" type="text" onkeypress="return isNumberKey(event);" required autocomplete="off" maxlength="16" class="form-control" placeholder="<?php echo app('translator')->getFromJson('user.card.card_no'); ?>">
                </div>
                ...
                <div class="form-group col-md-4 col-sm-12">
                    ...
                    <input type="text" data-stripe="cvc" onkeypress="return isNumberKey(event);" required autocomplete="off" maxlength="4" class="form-control" placeholder="<?php echo app('translator')->getFromJson('user.card.cvv'); ?>">
                </div>
            </div>
          </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        Stripe.setPublishableKey("<?php echo e(config('app.stripe_publishable_key', '')); ?>");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\t_connect\resources\views/user/account/payment.blade.php ENDPATH**/ ?>