      ...
      <div class="container">
        <div class="col-md-12">
            ...
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
              ...
              <a class="navbar-brand" href="<?php echo e(url('dashboard')); ?>"><img src="<?php echo e(config('constants.site_logo')); ?>"></a>
            </div>
...
</header><?php /**PATH C:\xampp\htdocs\t_connect\resources\views/user/include/header.blade.php ENDPATH**/ ?>