                                        ...
                                        <div class="row no-margin">
                                            ...
                                            <div class="prof-sub-col col-sm-4 col-xs-12 no-left-padding">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="<?php echo app('translator')->getFromJson('provider.amount'); ?>" name="amount" value="" required="">
                                                </div>
                                            </div>
                                            <div class="prof-sub-col col-sm-3 col-xs-12 no-right-padding">
                                                <div class="form-group">
                                                   <button type="submit" class="btn btn-block btn-primary update-link"><?php echo app('translator')->getFromJson('provider.transfer'); ?></button>
                                                </div>
                                            </div>
                                            </form>
                                        </div>
...
<?php echo $__env->make('provider.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\t_connect\resources\views/provider/wallet/transfer.blade.php ENDPATH**/ ?>