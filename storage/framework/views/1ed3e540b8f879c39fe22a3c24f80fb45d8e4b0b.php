                    ...
                    <div class="manage-doc-section-content row">
                        <div class="prof-sub-col col-xs-12">
                            ...
                            <div class="form-group">
                                <input tabindex="2" id="pac-input" class="form-control" type="text" placeholder="<?php echo app('translator')->getFromJson('provider.enter_location'); ?>" name="s_address">
                            </div>
                        </div>
...
<script>
    ...
    function initMap() {
        ...
        var userLocation = new google.maps.LatLng(
                <?php if(Auth::guard('provider')->user()->latitude): ?> <?php echo e(Auth::guard('provider')->user()->latitude); ?> <?php else: ?> 0.514277 <?php endif; ?>, 
                <?php if(Auth::guard('provider')->user()->longitude): ?> <?php echo e(Auth::guard('provider')->user()->longitude); ?> <?php else: ?> 35.269779 <?php endif; ?>
            );
...
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(Config::get('app.map_key')); ?>&libraries=places&callback=initMap&language=<?php echo app('translator')->getFromJson('provider.lang'); ?>" async defer></script>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('provider.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\t_connect\resources\views/provider/location/index.blade.php ENDPATH**/ ?>