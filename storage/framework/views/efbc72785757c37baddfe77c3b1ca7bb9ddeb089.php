...
<div class="log-overlay"></div>
    <div class="full-page-bg-inner">
        <div class="row no-margin">
                ...
                <p>Welcome to <?php echo e(config('constants.site_title','t-connect')); ?>, the easiest way to get around at the tap of a button.</p>
            </div>
            <div class="col-md-6 log-right">
                ...
                <div class="login-box row no-margin">
                    ...
                    <form role="form" method="POST" action="<?php echo e(url('/register')); ?>">
                        ...
                        <div id="first_step">
                            ...
                            <div class="col-md-8">
                                <input type="text" autofocus id="phone_number" class="form-control" placeholder="Enter Phone Number" name="phone_number" value="<?php echo e(old('phone_number')); ?>" data-stripe="number" maxlength="9" onkeypress="return isNumberKey(event);" />
                            </div>
                            ...
                            <div class="col-md-12" style="padding-bottom: 10px;">
                               <a href="<?php echo e(url('/send-otp')); ?>" class="log-teal-btn small verify_btn" id="otpSubmit">Verify Phone Number</a>
                            </div>
                        ...
                        <div id="second_step" style="display: none;">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" placeholder="First Name" name="first_name" value="<?php echo e(old('first_name')); ?>" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="First Name can only contain alphanumeric characters and . - spaces">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" placeholder="Last Name" name="last_name" value="<?php echo e(old('last_name')); ?>" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="Last Name can only contain alphanumeric characters and . - spaces">
                            ...
                            <div class="col-md-12">
                                <input type="email" class="form-control" name="email" placeholder="Email Address" value="<?php echo e(old('email')); ?>" data-validation="email">
                ...
                <div class="log-copy"><p class="no-margin"><?php echo e(config('constants.site_copyright', '&copy; '.date('Y').' t-connect')); ?></p></div>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('user.layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\t_connect\resources\views/user/auth/register.blade.php ENDPATH**/ ?>