                        ...
                        <form class="profile-form" action="<?php echo e(route('provider.profile.update')); ?>" method="POST" enctype="multipart/form-data" role="form">
                            ...
                            <div class="prof-form-sub-sec">
                                <div class="row no-margin">
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-left-padding">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="<?php echo app('translator')->getFromJson('provider.profile.first_name'); ?>" name="first_name" value="<?php echo e(Auth::guard('provider')->user()->first_name); ?>" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="<?php echo app('translator')->getFromJson('provider.profile.first_name'); ?> <?php echo app('translator')->getFromJson('provider.profile.error_msg'); ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="row no-margin">
                                    ...
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-left-padding">
                                        <div class="form-group">
                                            <label>&nbsp;</label>
                                            <a class="btn btn-block btn-primary update-link update-mobile" style="margin-top: 0;"><?php echo app('translator')->getFromJson('provider.profile.change_mobile'); ?></a>
                                            <a class="btn btn-block btn-primary update-link verify-mobile" style="margin-top: 0; display: none;"><?php echo app('translator')->getFromJson('provider.profile.verify'); ?></a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="prof-form-sub-sec border-top">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="<?php echo app('translator')->getFromJson('provider.profile.address'); ?>" name="address" value="<?php echo e(Auth::guard('provider')->user()->profile ? Auth::guard('provider')->user()->profile->address : ""); ?>">
                                    <input type="text" class="form-control" placeholder="<?php echo app('translator')->getFromJson('provider.profile.full_address'); ?>" style="border-top: none;" name="address_secondary" value="<?php echo e(Auth::guard('provider')->user()->profile ? Auth::guard('provider')->user()->profile->address_secondary : ""); ?>">
                                </div>
                                ...
                                <!-- <div class="row no-margin">
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-left-padding">
                                        <div class="form-group no-margin">
                                            ...
                                            <input type="text" class="form-control" placeholder="<?php echo app('translator')->getFromJson('provider.profile.city'); ?>" name="city" value="<?php echo e(Auth::guard('provider')->user()->profile ? Auth::guard('provider')->user()->profile->city : ""); ?>">
                                        </div>
                                    </div>
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-right-padding">
                                        <div class="form-group">
                                ...
                                <div class="row no-margin">
                                    <!-- <div class="prof-sub-col col-sm-6 col-xs-12 no-left-padding">
                                        <div class="form-group no-margin">
                                            ...
                                            <input type="text" class="form-control" placeholder="<?php echo app('translator')->getFromJson('provider.profile.pin'); ?>" name="postal_code" value="<?php echo e(Auth::guard('provider')->user()->profile ? Auth::guard('provider')->user()->profile->postal_code : ""); ?>">
                                        </div>
                                    </div> -->
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-left-padding">
                                        <div class="form-group">
                                ...
                                <div class="row no-margin">                                    
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-left-padding">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  placeholder="<?php echo app('translator')->getFromJson('provider.profile.car_model'); ?>" class="form-control" name="service_model" value="<?php echo e(Auth::guard('provider')->user()->service->service_model ? Auth::guard('provider')->user()->service->service_model : ""); ?>" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="<?php echo app('translator')->getFromJson('provider.profile.car_model'); ?> <?php echo app('translator')->getFromJson('provider.profile.error_msg'); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('provider.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\t_connect\resources\views/provider/profile/index.blade.php ENDPATH**/ ?>