...
<?php if(Auth::user()->status=='document'): ?>
<div class="pro-dashboard-head">
    <div class="container">
        <a href="#" class="pro-head-link active"><?php echo app('translator')->getFromJson('provider.document_pending'); ?></a>
    </div>
</div>
            ...
            <div class="row no-margin">
                <div className="col-md-12">  
                    <form method="POST" action="provider/profile/available">
                        ...
                        <a href="<?php echo e(route('provider.documents.index')); ?>" class="full-primary-btn"><?php echo app('translator')->getFromJson('provider.document_upload'); ?></a>
                    </form>
                </div>
            </div>
        </div>
...
<?php elseif(Auth::user()->status=='card'): ?>
<div class="pro-dashboard-head">
    <div class="container">
        <a href="#" class="pro-head-link active"><?php echo app('translator')->getFromJson('provider.card_pending'); ?></a>
    </div>
</div>
<div class="pro-dashboard-content">
    <div class="container">
            ...
            <div class="row no-margin">
                <div className="col-md-12">  
                    <form method="POST" action="provider/profile/available">
                        ...
                        <a href="<?php echo e(route('provider.cards')); ?>" class="full-primary-btn"><?php echo app('translator')->getFromJson('provider.card.add_debit_card'); ?></a>
                    </form>
                </div>
            </div>
        </div>
...
<?php elseif(Auth::user()->status=='balance'): ?>
<div class="pro-dashboard-head">
    <div class="container">
        <a href="#" class="pro-head-link active"><?php echo app('translator')->getFromJson('provider.negative_balance'); ?></a>
    </div>
</div>
<div class="pro-dashboard-content">
    <div class="container">
...
<div class="pro-dashboard-head">
    <div class="container">
        ...
        <a href="#" class="pro-head-link active"><?php echo app('translator')->getFromJson('provider.drive_now'); ?></a>
    </div>
</div>
<div class="pro-dashboard-content">
    <div class="container">
...
<script type="text/javascript">
    ...
    $(document).on('click', '#waiting_div', function(){
        ...
        if(test_status!=1){
                $.ajax({
                url: "<?php echo e(url('/provider/waiting')); ?>",
                type: 'post',
                data: {
...
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(Config::get('app.map_key')); ?>&libraries=places&language=<?php echo app('translator')->getFromJson('provider.lang'); ?>" defer></script>
<script type="text/javascript">
    var online="<?php echo app('translator')->getFromJson('provider.online'); ?>";
    var offline="<?php echo app('translator')->getFromJson('provider.offline'); ?>";
    var map;
    var request=0;
    var currency="<?php echo e(config('constants.currency')); ?>";
    var routeMarkers = {
                source: {
                    lat: 0,
                    lng: 0,
    ...
    function initMap() {
        ...
        var center = new google.maps.LatLng('0.5', '35');
...
function sendSubscriptionToBackEnd(subscription) {
    $.ajax({
            url: "/save-subscription/<?php echo e(Auth::user()->id); ?>/provider",
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('provider.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\t_connect\resources\views/provider/index.blade.php ENDPATH**/ ?>