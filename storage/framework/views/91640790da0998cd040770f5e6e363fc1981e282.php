            ...
            <div class="full-page-bg-inner">
                <div class="row no-margin">
                    <div class="col-md-6 log-left">
                        ...
                        <h2><?php echo e(config('constants.site_title','t-connect')); ?> needs partners like you.</h2>
                        <p>Drive with <?php echo e(config('constants.site_title','t-connect')); ?> and earn great money as an independent contractor. Get paid weekly just for helping our community of riders get rides around town. Be your own boss and get paid in fares for driving on your own schedule.</p>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\t_connect\resources\views/provider/layout/auth.blade.php ENDPATH**/ ?>