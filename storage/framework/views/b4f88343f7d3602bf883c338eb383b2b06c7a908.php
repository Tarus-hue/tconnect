    ...
    <div class="dash-left">
        ...
        <div class="side-menu">
             <ul>
                ...
                <!-- <li class="dropdown"><a class="dropdown-toggle"><?php echo app('translator')->getFromJson('user.profile.settings'); ?></a>
...
</div><?php /**PATH C:\xampp\htdocs\t_connect\resources\views/user/include/nav.blade.php ENDPATH**/ ?>