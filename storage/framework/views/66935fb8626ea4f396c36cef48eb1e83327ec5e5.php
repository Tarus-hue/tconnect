...
<div class="banner row no-margin" style="background-position: center; background-image: url('<?php echo e(asset('asset/img/slider-bg-1.jpg')); ?>');">
    <div class="banner-overlay"></div>
...
<div class="row white-section pad-60">
    <div class="container">
        ...
        <div class="col-md-6">
            ...
            <p><?php echo e(config('constants.site_title', 't-connect')); ?> is the smartest way to get around. One tap and a veterinary officer will be directed to your farm. You can pay with either cash or M-pesa.</p>
            <a class="content-more more-btn" href="<?php echo e(url('/ride')); ?>">MORE REASONS TO USE THE SERVICE <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
    </div>
</div>
...
<div class="row gray-section pad-60">
    <div class="container">                
        <div class="col-md-6">
            ...
            <div class="title-divider"></div>
            <p>One of the main benefits that we see in going online is that getting a good veterinary at the right time is a real struggle. Count on <?php echo e(config('constants.site_title', 't-connect')); ?> </p>
            <a class="content-more more-btn" href="<?php echo e(url('/ride')); ?>">MORE REASONS TO RIDE <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
        <div class="col-md-6 img-box text-center"> 
...
<div class="row white-section pad-60">
    <div class="container">
        ...
        <div class="col-md-6 content-block">
            ...
            <h2>Convenience</h2>
            <div class="title-divider"></div>
            <p>With <?php echo e(config('constants.site_title', 't-connect')); ?>, you can make a request at your farm and wait for the veterinary officer to arrive. This can save you a lot of hassle and time.</p>
            <a class="content-more more-btn" href="<?php echo e(url('/ride')); ?>">MORE REASONS TO RIDE <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
</div>
...
<div class="row gray-section pad-60 full-section">
    <div class="container">                
        <div class="col-md-6 content-block">
            ...
            <div class="title-divider"></div>
            <p>What makes the <?php echo e(config('constants.site_title', 't-connect')); ?> experience truly great is going online. Today, with increased internet connectivity we cannot deny that digital transformation is already an unstoppable process. This is why we have worked to adapt and take advantage of what it has to offer.</p>
            <a class="content-more more-btn" href="<?php echo e(url('/drive')); ?>">WHY DRIVE WITH <?php echo e(config('constants.site_title', 't-connect')); ?> <i class="fa fa-chevron-right"></i></a>
        </div>
...
<div class="row white-section pad-60 ">
    <div class="container">
        ...
        <div class="col-md-6 content-block">
            ...
            <div class="title-divider"></div>
            <p><?php echo e(config('constants.site_title', 't-connect')); ?> selects qualified & experienced veterinary officers. You should therefore have the peace of mind that you are getting the best professional service.</p>
            <a class="content-more more-btn" href="<?php echo e(url('/login')); ?>">OUR LOCAL IMPACT <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
</div>
...
<div class="row gray-section pad-60 full-section">
    <div class="container">
        <div class="col-md-6 content-block">
            ...
            <div class="title-divider"></div>
            <p>Many a time, getting AI services when the need arises is a real struggle. <?php echo e(config('constants.site_title', 't-connect')); ?> links you to the nearest officer </p>
            <a class="content-more more-btn" href="<?php echo e(url('/login')); ?>">HOW WE KEEP YOU SAFE <i class="fa fa-chevron-right"></i></a>
        </div>
        <!-- <div class="col-md-6 img-box text-center"> 
...
<div class="row find-city">
    <div class="container pad-60 content-block center">
        <h2>Find out if <?php echo e(config('constants.site_title','t-connect')); ?> is in your county</h2>
        <div class="row">
...
<?php echo $__env->make('user.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\t_connect\resources\views/newindex.blade.php ENDPATH**/ ?>