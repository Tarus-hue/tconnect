...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(config('constants.site_favicon', asset('favicon.ico'))); ?>" type="image/x-icon">
    <link rel="icon" href="<?php echo e(config('constants.site_favicon', asset('favicon.ico'))); ?>" type="image/x-icon">

    <title><?php echo $__env->yieldContent('title'); ?><?php echo e(config('constants.site_title', 't-connect')); ?></title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="demoModeDialog" class="demoModeDialogmodal">
            ...
            <?php endif; ?>
        <?php echo $__env->make('provider.layout.partials.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div id="page-content-wrapper">
            <?php echo $__env->make('provider.layout.partials.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('provider.layout.partials.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\t_connect\resources\views/provider/layout/app.blade.php ENDPATH**/ ?>