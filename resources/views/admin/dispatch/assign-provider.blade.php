                            ...
                            <a class="text-black" href="#">
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <h6 class="media-heading">Address: Nairobi, Kenya</h6>
                                        <h6 class="media-heading">Phone No: +254 735929091</h6>
                                        <h6 class="media-heading">Email: nickiprotich@gmail.com</h6>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a class="text-black" href="#">
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <h6 class="media-heading">Address: Nairobi, Kenya</h6>
                                        <h6 class="media-heading">Phone No: +254 735929091</h6>
                                        <h6 class="media-heading">Email: nichkiprotich@gmail.com</h6>
                                    </div>
                                </div>
                            </a>
                            <a class="btn btn-success mt-1" href="/admin/dispatcher/cancel?request_id=651">Assign Provider</a>
