  ...
  <div class="tab-content" id="myTabContent">
    ...
    <form class="form-horizontal" action="{{ route('admin.settings.store') }}" method="POST" enctype="multipart/form-data" role="form" autocomplete="off">
				...
				<div class="form-group row">
					...
					<div class="col-xs-9">
						<input class="form-control" type="text" value="{{ config('constants.site_title', 't-connect')  }}" name="site_title" required id="site_title" placeholder="Site Name">
					</div>
				</div>
				...
				<div class="form-group row">
                    ...
                    <div class="col-xs-9">
                        <input class="form-control" type="text" value="{{ config('constants.site_copyright', '&copy; '.date('Y').'t-connect') }}" name="site_copyright" id="site_copyright" placeholder="Site Copyright">
                    </div>
                </div>
