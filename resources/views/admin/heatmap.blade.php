...
@section('scripts')
	<script async src="https://maps.googleapis.com/maps/api/js?key={{config('app.map_key')}}&libraries=visualization"></script>
	...
	<script type="text/javascript">
      ...
      function initMap(latitude = 0.5143, longitude = 35.2698) {
