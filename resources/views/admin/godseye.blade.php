...
@section('scripts')
	<script src="https://maps.googleapis.com/maps/api/js?key={{Config::get('app.map_key')}}&libraries=places&language=en"></script>
	<script>
	...
	function initialize(latitude = 0.5143, longitude = 35.2698) {
