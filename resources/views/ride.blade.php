            ...
            <div class="col-md-4">
                <div class="banner-form">
                    <div class="row no-margin fields">
                        ...
                        <div class="right">
                            <a href="{{url('login')}}">
                                <h3>Ride with {{config('constants.site_title','t-connect')}}</h3>
    ...
    <div class="row white-section pad-60 no-margin">
        <div class="container ">
            ...
            <div class="col-md-4 content-block small">
                ...
                <p>{{ config('constants.site_title', 't-connect')  }} is the smartest way to get around. One tap and a car comes directly to you. Your driver knows exactly where to go. And you can pay with either cash or card.</p>
            </div>
        </div>
            ...
            <div class="col-md-4 content-block small">
                ...
                <div class="title-divider"></div>
                <p>When you arrive at your destination, either pay with cash or have your card automatically charged. With {{ config('constants.site_title', 't-connect') }}, the choice is yours.</p>
            </div>
        </div>
         ...
         <div class="icon"><img src="{{ asset('asset/img/destination.png') }}"></div>               
            ...
            <div class="car-tab">
                <ul class="nav nav-tabs">
                  <li class="active"><a data-toggle="tab" href="#economy">Treatment</a></li>
                  <li><a data-toggle="tab" href="#premium">Vaccination</a></li>
                  <li><a data-toggle="tab" href="#accessibility">AI Service</a></li>
                  <li><a data-toggle="tab" href="#carpool">Meat Inspection</a></li>
                </ul>
    ...
    <div class="row white-section pad-60">
        <div class="container">
            ...
            <div class="col-md-6 content-block">
                 <div class="icon"><img src="{{ asset('asset/img/budget.png') }}"></div>    
                <h4>Pricing</h4>
                <h2>Cost estimate excluding service</h2>
                <div class="title-divider"></div>
    ...
    <!-- <div class="row gray-section no-margin">
        <div class="container">                
            <div class="col-md-6 content-block">
                ...
                <div class="title-divider"></div>
                <p>Whether riding in the backseat or driving up front, every part of the {{ config('constants.site_title', 't-connect') }} experience has been designed around your safety and security.</p>
...
<div class="row find-city">
    ...
    <!-- <div class="row find-city no-margin">
        <div class="container">
            <h2>{{config('constants.site_title','t-connect')}} is in your city</h2>
            <form>
                <div class="input-group find-form">
...
$(document).ready(function () {
    ...
    $.ajax({
       ...
       { 
           ...
           $("#div2").show();
           $("#btnSubmit").hide();
           $("#div1").html("Estimated Fare - Ksh"+data.estimated_fare);
