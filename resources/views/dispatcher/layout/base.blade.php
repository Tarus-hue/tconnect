...
<head>
    ...
    <!-- Title -->
    <title>@yield('title'){{ config('constants.site_title', 't-connect') }} - Dispatcher Panel</title>
...
<body class="fixed-sidebar fixed-header content-appear skin-default">
    ...
    <div class="wrapper">
        ...
        @include('dispatcher.include.nav')

        @include('dispatcher.include.header')
        ...
        <div class="site-content">
            ...
            @include('dispatcher.include.footer')
