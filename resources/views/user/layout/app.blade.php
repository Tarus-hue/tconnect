...
<head>
    ...
    <title>{{ config('constants.site_title','t-connect') }}</title>
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                <li @if(Request::url() == url('/ride')) class="active" @endif>
                                    <a href="{{url('/ride')}}">Client</a>
                                </li>
                                <li @if(Request::url() == url('/drive')) class="active" @endif>
                                    <a href="{{url('/drive')}}">Veterinary</a>
                                </li>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a class="btn-outline" href="{{url('/register')}}">Signup-Client</a></li>
                                <li><a class="menu-btn" href="{{url('/provider/register')}}">Signup-veterinary</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-2 col-md-offset-1 support">
                 ...
                 <div class="col-xs-12 col-sm-12  col-md-6 sup-txt"><h2>For Support?     Call Us</h2>
                     <div class="call-num">
<h3 class=""><a href="tel:{{ config('app.contact_number', '+254735929091
')  }}"><!-- <span class="phone-icon"><i class="fa fa-3x fa-phone"></i></span> --> {{ config('app.contact_number', '+254735929091')  }}</a> </h3>
                </div>
             </div>
            ...
            <!--  <div class="col-md-12">
                <div class="call-num">
<h3 class=""><a href="tel:{{ config('constants.contact_number', '')  }}"><span class="phone-icon"><i class="fa fa-3x fa-phone"></i></span> {{ config('constants.contact_number', '+254735929091')  }}</a> </h3>
                </div>
                   ...
                   <ul>
                        ...
                        <div class="row no-margin">
                            <div class="col-md-12 copy">
                                <p>{{ config('constants.site_copyright', '&copy; '.date('Y').' t-connect') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>{{ config('constants.site_title','t-connect') }} is available in your county</p>
      </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key={{ Config::get('app.map_key') }}&libraries=places&callback=initMap" async defer></script>
