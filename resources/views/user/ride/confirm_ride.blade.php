            ...
            <div class="col-md-6">
                ...
                {{ csrf_field() }}
                    ...
                    <select class="form-control" name="payment_mode" id="payment_mode">
                     <option value="" data-percent="0" data-max="0">@lang('user.payment_method')</option>
...
@section('scripts')
  ...
  <script>
    ...
    $(document).ready(function(e) {
          ...
          $.ajax({
            url: "https://maps.googleapis.com/maps/api/directions/json?origin={{$request->s_latitude}},{{$request->s_longitude}}&destination={{$request->d_latitude}},{{$request->d_longitude}}&mode=driving&key={{config('app.map_key')}}", 
            type: "GET",   
            dataType: 'jsonp',
            cache: false,
